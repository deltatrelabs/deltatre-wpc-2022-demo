namespace Deltatre.ObjectDetector.YOLOv7.MLModels
{
    ...
    public class Yolov7_640Model : YoloModel
    {
        // From: https://github.com/WongKinYiu/yolov7/blob/main/cfg/deploy/yolov7.yaml

        public override string Name { get; set; } = "Yolov7_640";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov7_640.onnx";
