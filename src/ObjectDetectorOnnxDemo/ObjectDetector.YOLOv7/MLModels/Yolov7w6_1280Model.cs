namespace Deltatre.ObjectDetector.YOLOv7.MLModels
{
    ...
    public class Yolov7w6_1280Model : YoloModel
    {
        // From: https://github.com/WongKinYiu/yolov7/blob/main/cfg/deploy/yolov7w6.yaml

        public override string Name { get; set; } = "Yolov7w6_1280";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov7-w6_1280.onnx";
