namespace Deltatre.ObjectDetector.YOLOv7.MLModels
{
    ...
    public class Yolov7e6e_640Model : YoloModel
    {
        // From: https://github.com/WongKinYiu/yolov7/blob/main/cfg/deploy/yolov7e6e.yaml

        public override string Name { get; set; } = "Yolov7e6e_640";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov7-e6e_640.onnx";
        ...
        {
            new int[][] { new int[] {  19,  27 }, new int[] {  44,  40 }, new int[] {  38,  94 } },
            new int[][] { new int[] {  96,  68 }, new int[] {  86, 152 }, new int[] { 180, 137 } },
