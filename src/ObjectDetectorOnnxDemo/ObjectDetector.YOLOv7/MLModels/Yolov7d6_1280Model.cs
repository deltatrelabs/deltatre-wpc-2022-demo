namespace Deltatre.ObjectDetector.YOLOv7.MLModels
{
    ...
    public class Yolov7d6_1280Model : YoloModel
    {
        // From: https://github.com/WongKinYiu/yolov7/blob/main/cfg/deploy/yolov7d6.yaml

        public override string Name { get; set; } = "Yolov7d6_1280";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov7-d6_1280.onnx";
