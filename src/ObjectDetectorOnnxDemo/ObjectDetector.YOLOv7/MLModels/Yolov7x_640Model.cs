namespace Deltatre.ObjectDetector.YOLOv7.MLModels
{
    ...
    public class Yolov7x_640Model : YoloModel
    {
        // From: https://github.com/WongKinYiu/yolov7/blob/main/cfg/deploy/yolov7x.yaml

        public override string Name { get; set; } = "Yolov7x_640";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov7x_640.onnx";
        ...
        public override int Dimensions { get; set; } = 80+5;

        public override int[] Strides { get; set; } = new int[] { 8, 16, 32 };

        public override int[][][] Anchors { get; set; } = new int[][][]
        {
            new int[][] { new int[] {  12,  16 }, new int[] {  19,  36 }, new int[] {  40,  28 } },
            new int[][] { new int[] {  36,  75 }, new int[] {  76,  55 }, new int[] {  72, 146 } },
            new int[][] { new int[] { 142, 110 }, new int[] { 192, 243 }, new int[] { 459, 401 } }
        };
